    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('snapshot', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='snapshot_templates', to='pipeline.snapshot', verbose_name='模板结构数据')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='pipeline.pipelinetemplate', verbose_name='Pipeline模板')),
                ('execution_snapshot', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='execution_snapshot_instances', to='pipeline.snapshot', verbose_name='用于实例执行的结构数据')),
                ('snapshot', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='snapshot_instances', to='pipeline.snapshot', verbose_name='实例结构数据，指向实例对应的模板的结构数据')),
                ('tree_info', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tree_info_instances', to='pipeline.treeinfo', verbose_name='提前计算好的一些流程结构数据')),
            ],
            options={
