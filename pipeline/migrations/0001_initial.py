    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instance_id', models.CharField(max_length=32,
                                                 unique=True, verbose_name='\u5b9e\u4f8bID')),
                ('name', models.CharField(default='\u9ed8\u8ba4\u5b9e\u4f8b',
                                          max_length=64, verbose_name='\u5b9e\u4f8b\u540d\u79f0')),
                ('creator', models.CharField(
                    max_length=32, verbose_name='\u521b\u5efa\u8005')),
                ('create_time', models.DateTimeField(
                    auto_now_add=True, verbose_name='\u521b\u5efa\u65f6\u95f4')),
                ('executor', models.CharField(
                    max_length=32, verbose_name='\u6267\u884c\u8005')),
                ('start_time', models.DateTimeField(blank=True,
                                                    null=True, verbose_name='\u542f\u52a8\u65f6\u95f4')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True,
                                                 null=True, verbose_name='\u63cf\u8ff0')),
                ('editor', models.CharField(blank=True, max_length=32,
                                            null=True, verbose_name='\u4fee\u6539\u8005')),
